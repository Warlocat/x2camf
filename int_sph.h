...
protected:
    ...
    // For Gaunt integral
    double get_radial_LSLS_J(const int& lp, const int& lq, const int& LL, const double& a1, const double& a2, const double& a3, const double& a4, const double& lk1, const double& lk2, const double& lk3, const double& lk4, double radial_list[4], const bool& spinFree = false) const;
    double get_radial_LSLS_K(const int& lp, const int& lq, const int& LL, const double& a1, const double& a2, const double& a3, const double& a4, const double& lk1, const double& lk2, const double& lk3, const double& lk4, double radial_list[4], const bool& spinFree = false) const;
